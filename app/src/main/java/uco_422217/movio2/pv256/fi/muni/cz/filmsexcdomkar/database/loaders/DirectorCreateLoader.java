...
public class DirectorCreateLoader extends AsyncTaskLoader<List<Director>> {
    private Context mContext;
    private FilmManager mFilmManager;
    private Director mDirector;

    public DirectorCreateLoader(Context context, Director director) {
        super(context);
        mContext = context;
    ...
    public List<Director> loadInBackground() {
        mFilmManager.createDirector(mDirector);
